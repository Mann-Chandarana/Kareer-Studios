                        ...
                        <div className='col-xs-4 col-xs-offset-4'>
                            <div className='floating-label-group'>
                                <div className='floating-label-group mt-2'>
                                    <label className='floating-label '>Add Comment for your counsellor</label>
                                    <textarea className='form-control' style={{ fontSize: '14px', resize: 'vertical' }} rows='2' name='comment' value={feedback.comment} onChange={handleChange} autoComplete='off' autoFocus required></textarea>
                                </div>

                                <div className='floating-label-group mt-4'>
                                    <label className=' form-check-label'>Date: </label>
                                    <input onChange={handleChange} type='date' name='date' value={feedback.date} autoComplete='off' className='form-check-input mx-1' style={{ width: '8rem', height: '20px' }} />
                                </div>
