        ...
        <form onSubmit={handleSubmit} ref={formRef} noValidate>
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='name' type='text' pattern='^[a-z A-Z]*$' className='form-control' id='name' value={formState.name || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <textarea onChange={handleChange} value={formState.address || ''} name='address' className='form-control' id='address' style={{ height: '100px' }} required></textarea>
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='phone' type='tel' pattern='[0-9]{10}' className='form-control' id='phone' value={formState.phone || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='qualifiction' type='text' className='form-control' id='qualifiction' value={formState.qualifiction || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='experience' type='number' className='form-control' id='experience' value={formState.experience || 0} required min={0} />
                    <div className='invalid-feedback'>Please enter a valid experience.</div>
                </div>
            </div>
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='bank_name' type='text' className='form-control' id='bank_name' value={formState.bank_name || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='bank_ifsc' type='text' className='form-control' id='bank_ifsc' value={formState.bank_ifsc || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='bank_ac' type='text' minLength={10} maxLength={20} pattern='^[0-9]*$' className='form-control' id='bank_ac' value={formState.bank_ac || ''} required />
            ...
            <div className='row mb-3'>
                ...
                <div className='col-md-8 col-lg-9'>
                    <input onChange={handleChange} name='bank_micr' type='text' className='form-control' id='bank_micr' value={formState.bank_micr || ''} required />
