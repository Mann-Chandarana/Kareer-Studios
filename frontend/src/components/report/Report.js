      ...
      <div>
        ...
        <center>
          ...
          <CCard className="text-center w-75">
            ...
            <CCardBody>
              ...
              <CCardText style={{ textAlign: "left" }}>
                ...
                and may be limited by being indecisive, overly accommodating,
                and a tendency to avoid change. You may fear change, loss of
                stability, and offending others. You always values loyalty,
                helping others and security. What you naturally do well...{" "}
                <br></br>
                <br></br>• You’re a natural ‘people person’ and enjoy helping
                other people succeed. <br></br>• You’re good at building
                relationships and networking – the key to your success.{" "}
                <br></br>• You get fulfilment from satisfying social needs like
                friendship, sense of belonging and community service. <br></br>•
                You’re a team player, loyal, easy to get along with, patient and
                reliable. <br></br>• You are happy to follow plans as part of a
                team, but not necessarily on your own. <br></br>• You are
                motivated by relationships, shared goals, community service and
                the common good.
              </CCardText>
            </CCardBody>
          </CCard>
                ...
                <CTableBody>
                  <CTableRow>
                    <CTableDataCell style={{ textAlign: "left" }}>
                      Leadership role<br></br>Managerial role
                    </CTableDataCell>
                    <CTableDataCell style={{ textAlign: "left" }}>
                      Liberal Arts <br></br> - Management <br></br>- Psychology
                    </CTableDataCell>
                    <CTableDataCell style={{ textAlign: "left" }}>
                      1. General Management<br></br>
          ...
          <CCard className="text-center w-75">
            ...
            <CCardBody>
              <CCardText style={{ textAlign: "left" }}>
                DOER personality, can’t be successful in strategy making role.
                She must work with people, work for people to achieve highest
                level of job satisfaction. Communication skill is dormant and
                needs to be improve. Recommended “Design Thinking workshop” and
                “Theatre Activity” to improve problem solving ability and
                communication style.
              </CCardText>
            </CCardBody>
          </CCard>
