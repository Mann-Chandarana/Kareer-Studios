...
import { CCard, CCardHeader, CCardBody, CCardTitle, CCardText, CCol, CRow, CCarousel, CCarouselItem, CTable, CTableHead, CTableHeaderCell, CTableRow, CTableDataCell, CTableBody, CButton } from '@coreui/react';
                    ...
                    <center>
                        ...
                        <CCard className='text-center w-75'>
                            ...
                            <CCardBody>
                                ...
                                <CCardText style={{ textAlign: 'left' }}>{pt_info}</CCardText>
                            </CCardBody>
                        </CCard>
                        ...
                        <CCard className='text-center w-75'>
                            ...
                            <CCardBody>
                                <CTable hover bordered>
                                    ...
                                    <CTableBody>
                                        <CTableRow>
                                            <CTableDataCell style={{ textAlign: 'left' }}>{sc_careers}</CTableDataCell>
                                            <CTableDataCell style={{ textAlign: 'left' }}>{sc_stream}</CTableDataCell>
                                            <CTableDataCell style={{ textAlign: 'left' }}>{sc_subjects}</CTableDataCell>
                                        </CTableRow>
                                    </CTableBody>
                                </CTable>
                            </CCardBody>
                        ...
                        <CCard className='text-center w-75'>
                            ...
                            <CCardBody>
                                <CCardText style={{ textAlign: 'left' }}>{additional_note}</CCardText>
                            </CCardBody>
                        </CCard>
