...
function CounsellorStudentTable() {
    ...
    useEffect(() => {
        if (user.messages !== null && user.messages !== 0) {
            toast.success(`You have ${user.messages} new Comments`, {
                position: 'top-center',
                autoClose: 1000,
                    ...
                    <div className='col-12'>
                        <div className='card top-selling overflow-auto'>
                            <div className='filter d-flex align-items-center'>
                                ...
                                <ModalButton id='generate-link' className='btn btn-success btn-sm mx-4' onClick={() => fetchLink()}>
                                    Generate Link
                                </ModalButton>
                            </div>
                            <div className='card-body pb-0'>
                                <h5 className='card-title'>
                                    Students Accounts
                                    <br />
                                    <span style={{ fontSize: '14px' }}>Total students: {loading ? <SmallSpinner /> : students.length}</span>
                                </h5>
                                        ...
                                        <tr>
                                            {loading || (
                                                <>
                                                    ...
                                                    <th scope='col'>Suggested Programs</th>
                                                </>
                                            )}
                                        </tr>
                                    </thead>
                                                    ...
                                                    <tr key={student.id}>
                                                        ...
                                                        <td>
                                                            <Modal id={'edit_s_' + student.id}>
                                                                <EditStudent callback={getStudents} studentData={student} />
                                                            </Modal>
                                                        ...
                                                        <td>
                                                            {student.fileurl ? (
                                                                <a href={student.fileurl} download={student.filename} target='_blank' rel='noreferrer'>
