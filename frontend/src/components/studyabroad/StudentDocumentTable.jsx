        ...
        <div className="pagetitle">
          ...
          <nav>
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active">Upload Documents</li>
            </ol>
          </nav>
        </div>
                        ...
                        return (
                          <tr key={student.id}>
                            ...
                            <td>
                              ...
                              > <Link to={"/document/" + student.id} className="text-white">View </Link>
                              </ModalButton>
                            </td>
                          </tr>
                        );
...
export default StudentDocumentTable;
