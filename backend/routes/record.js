...
router.post('/addAcademicScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {
        ...
        if (rowCount > 0) {
            ...
            const { ssc_board, ssc_year, ssc_score, ssc_backlog, hsc_board, hsc_year, hsc_score, hsc_backlog, diploma_uni, diploma_year, diploma_score, diploma_backlog, ug_uni, ug_year, ug_score, ug_backlog } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addAcademicScore(student_id, ssc_board, ssc_year, ssc_score, ssc_backlog, hsc_board, hsc_year, hsc_score, hsc_backlog, diploma_uni, diploma_year, diploma_score, diploma_backlog, ug_uni, ug_year, ug_score, ug_backlog);
...
router.post('/addIeltsScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {        
            ...
            const { ielts_listening_score, ielts_reading_score, ielts_writing_score, ielts_speaking_score, ielts_date } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addIeltsScore(student_id, ielts_listening_score, ielts_reading_score, ielts_writing_score, ielts_speaking_score, ielts_date);
...
router.post('/addPteScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {      
            ...
            const { pte_listening_score, pte_reading_score, pte_writing_score, pte_speaking_score, pte_date } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addPteScore(student_id, pte_listening_score, pte_reading_score, pte_writing_score, pte_speaking_score, pte_date);
...
router.post('/addGreScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {
            ...
            const { gre_verbal_score, gre_quant_score, gre_writing_score, gre_date } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addGreScore(student_id, gre_verbal_score, gre_quant_score, gre_writing_score, gre_date);
...
router.post('/addSatScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {
            ...
            const { sat_math_score, sat_english_score, sat_essay_score, sat_date } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addSatScore(student_id, sat_math_score, sat_english_score, sat_essay_score, sat_date);
...
router.post('/addGmatScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {
            ...
            const { gmat_verbal_score, gmat_quant_score, gmat_writing_score, gmat_date } = req.body;

            console.log(req.body);
            console.log(student_id);

            await recordHandler.addGmatScore(student_id, gmat_verbal_score, gmat_quant_score, gmat_writing_score, gmat_date);
...
router.put('/updateAcademicScore/:student_id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updateAcademicScore(student_id, ssc_board, ssc_year, ssc_score, ssc_backlog, hsc_board, hsc_year, hsc_score, hsc_backlog, diploma_uni, diploma_year, diploma_score, diploma_backlog, ug_uni, ug_year, ug_score, ug_backlog);
...
router.put('/updateIeltsScore/:id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updateIeltsScore(id, ielts_listening_score, ielts_reading_score, ielts_writing_score, ielts_speaking_score, ielts_date);
...
router.put('/updatePteScore/:id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updatePteScore(id, pte_listening_score, pte_reading_score, pte_writing_score, pte_speaking_score, pte_date);
...
router.put('/updateGreScore/:id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updateGreScore(id, gre_verbal_score, gre_quant_score, gre_writing_score, gre_date);
...
router.put('/updateSatScore/:id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updateSatScore(id, sat_math_score, sat_english_score, sat_essay_score, sat_date);
...
router.put('/updateGmatScore/:id', verifyStudents, async(req, res) => {
    ...
    try {  
            ...
            await recordHandler.updateGmatScore(id, gmat_verbal_score, gmat_quant_score, gmat_writing_score, gmat_date);
